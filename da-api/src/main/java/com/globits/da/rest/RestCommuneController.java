...
public class RestCommuneController {
    ...
    @PutMapping("/{id}")
    public ApiResponse<CommuneResponseDto> updateCommune(@RequestBody CommuneRequestDto dto, @PathVariable Long id){ApiResponse<CommuneResponseDto>result=new ApiResponse<>();
